package org.alexkolo.custom.configure.analyzer;

import org.alexkolo.custom.exception.BackgroundTaskPropertyException;
...
public class PropertyGuardEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        String defaultExecutor = environment.getProperty("background-executor.defaultExecutor");
        String taskSize = environment.getProperty("background-executor.taskSize");
        String timeValue = environment.getProperty("background-executor.time.inSeconds");
    ...
    private void check(String defaultExecutor, String taskSize, String timeValue, String cronExpression) {
        ...
        if ((!StringUtils.hasText(taskSize)) || (!taskSize.matches("-?\\d*"))
            ...
            throw new BackgroundTaskPropertyException("Invalid taskSize value");
        }
    }
